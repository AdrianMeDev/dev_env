...
vim.opt.tabstop = 2 -- set tab to 2 space characters
vim.opt.shiftwidth = 2 -- intendation set to 2 space characters
...
vim.api.nvim_create_autocmd('TextYankPost', {
  ...
  group = vim.api.nvim_create_augroup('ame-highlight-yank', { clear = true }),
  callback = function()
